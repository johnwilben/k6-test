...
const CATEGORY_IDS = ["3", "4", "5", "6"]; // adjust to actual category IDs
const SAMPLE_SKUS = ["SKU001", "SKU002", "SKU003"]; // adjust to real SKUs
const SAMPLE_URL_KEYS = ["gold-ring-001", "silver-necklace-001"]; // adjust to real url_keys
