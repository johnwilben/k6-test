...
// Option 2: JSON file        → -e TOKENS_FILE=tokens.json
// Option 3: CSV file         → -e TOKENS_CSV=users.csv
//   CSV format:
//     token
//     eyJ0eXAi...
//     eyJ0eXAi...
const TOKENS = new SharedArray("tokens", function () {
  ...
  if (__ENV.TOKENS_FILE) {
    ...
    console.log(`Loaded ${tokens.length} tokens from JSON: ${__ENV.TOKENS_FILE}`);
    return tokens;
  }
  // Single token
  if (__ENV.TOKEN) {
